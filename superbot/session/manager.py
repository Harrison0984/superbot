...
from superbot.utils.helpers import ensure_dir, safe_filename
...
class Session:
    ...
    The vector memory system handles long-term storage via recall().
    """
...
class SessionManager:
    ...
    def __init__(self, workspace: Path):
        ...
        self.legacy_sessions_dir = Path.home() / ".superbot" / "sessions"
    ...
    def _get_legacy_session_path(self, key: str) -> Path:
        """Legacy global session path (~/.superbot/sessions/)."""
        safe_key = safe_filename(key.replace(":", "_"))
