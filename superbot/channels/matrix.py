...
try:
    ...
    raise ImportError(
        "Matrix dependencies not installed. Run: pip install superbot-ai[matrix]"
    ) from e

from superbot.bus.events import OutboundMessage
from superbot.channels.base import BaseChannel
from superbot.config.loader import get_data_dir
from superbot.utils.helpers import safe_filename
